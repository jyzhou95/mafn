...
dt.return.this <- merge(dt.spy[,list(dt, spy_vol_90=vol_90, spy_pred_vol_90=pred_vol_90)],
                        dt.tlt[,list(dt, tlt_vol_90=vol_90, tlt_pred_vol_90=pred_vol_90)],
                        by = c("dt"))
dt.return.this[,spy_proportion_vol_90 := (1/spy_vol_90) / (1/spy_vol_90 + 1/tlt_vol_90)]
dt.return.this[,tlt_proportion_vol_90 := (1/tlt_vol_90) / (1/spy_vol_90 + 1/tlt_vol_90)]
dt.return.this[,spy_proportion_vol_90_pred := (1/spy_pred_vol_90) / (1/spy_pred_vol_90 + 1/tlt_pred_vol_90)]
dt.return.this[,tlt_proportion_vol_90_pred := (1/tlt_pred_vol_90) / (1/spy_pred_vol_90 + 1/tlt_pred_vol_90)]


# Previous 90 days volatility
dt.weighting_prev <- rbind(dt.return.this[,list(dt, symbol = "SPY", weighting = spy_proportion_vol_90)],
                           dt.return.this[,list(dt, symbol = "TLT", weighting = tlt_proportion_vol_90)])
